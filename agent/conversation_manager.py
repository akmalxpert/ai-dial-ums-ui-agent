...
class ConversationManager:
    ...
    async def create_conversation(self, title: str) -> dict:
        ...
        logger.info("Created conversation", extra={"conversation_id": conversation_id, "title": title})
        return conversation
    ...
    async def chat(
        ...
        """
        logger.info("Chat request", extra={"conversation_id": conversation_id, "stream": stream})
