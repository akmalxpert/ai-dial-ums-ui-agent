...
async def lifespan(app: FastAPI):
    ...
    ddg_tools = await ddg_mcp_client.get_tools()
    for tool in ddg_tools:
        tools.append(tool)
        tool_name_client_map[tool["function"]["name"]] = ddg_mcp_client
...
async def create_conversation(request: CreateConversationRequest):
    return await conversation_manager.create_conversation(title=request.title or "New Conversation")
